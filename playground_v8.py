...
def semantic_enrichment(triples_per_sentence,
    ...
    for sentence_idx, sentence_triples in triples_per_sentence.items():
        ...
        for subject, predicate, obj in sentence_triples:
            # Find synonyms for the SUBJECT
            synsets = wordnet.synsets(subject)
...
if __name__ == "__main__":
    ...
    if text == 'Test':
        ...
        # KG summary
        summary1_kg, summary2_kg, rank_df1_kg, rank_df2_kg, rouge_scores1_kg, mean_rouge1_kg, rouge_scores2_kg, mean_rouge2_kg, p1_kg, r1_kg, f11_kg, p2_kg, r2_kg, f12_kg, t_kg = summarization(test, num_sentences, percentage_txt, "Number of sentences", "Yes")        # Store results as a dictionary
        test_final_results.append({"Summary": summary,
                                   "Summary 1 KG": summary1_kg,
                                   "Summary 2 KG": summary2_kg,
                                   "ROUGE": rouge_scores,
                                   "ROUGE 1 KG": rouge_scores1_kg,
                                   "ROUGE 2 KG": rouge_scores2_kg,
                                   "Mean ROUGE": mean_rouge,
                                   "Mean ROUGE 1 KG": mean_rouge1_kg,
                                   "Mean ROUGE 2 KG": mean_rouge2_kg,
                                   "BERTScore": (p, r, f1),
                                   "BESTScore 1 KG": (p1_kg, r1_kg, f11_kg),
                                   "BERTScore 2 KG": (p2_kg, r2_kg, f12_kg),
                                   "Time": round(t, 2),
                                   "Time KG": round(t_kg, 2),
                                   "Ranking 1 KG": rank_df1_kg,
                                   "Ranking 2 KG": rank_df2_kg})
